...
describe('ProfileStatus component', () => {
    ...
    test('after creation <span> should be displayed with connect status', () => {
        const component = create(<ProfileStatus status='hello' />);
    ...
    test(`after creation <input> shouldn't be displayed with connect status`, () => {
        const component = create(<ProfileStatus status='hello' />);
        const root = component.root;
        expect(() => {
    ...
    test(`after creation <span> should contains corrent status`, () => {
        const component = create(<ProfileStatus status='hello' />);
        const root = component.root;
        let span = root.findByType('span');
